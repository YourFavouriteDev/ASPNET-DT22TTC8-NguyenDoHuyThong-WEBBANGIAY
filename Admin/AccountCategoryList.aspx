                ...
                <div class="span3">
                    ...
                    <div class="block-fluid">
                        <div class="row-form clearfix">
                                <asp:DropDownList ID="DropDown_CategoryList" runat="server"
                                    AutoPostBack="true" CssClass="category" 
                                    OnSelectedIndexChanged="DropDown_CategoryList_SelectedIndexChanged" />
                        </div>
                    </div>
                </div>
                <div class="span9">
                    <div class="head clearfix">
                        ...
                        <%--<ul class="buttons">
                            <li>
                                <a title="Thêm mới" class="isw-plus tip" style="cursor: no-drop;"></a>
                            </li>
                        </ul>--%>
                    </div>
                    <div class="block-fluid  customize">
                        <div class="row-form clearfix">
                            ...
                            <div class="span7">
                                <input type="text" class="tip" runat="server" id="input_ID" />
                            ...
                            <div class="span2" style="float: right;">
                                <input type="text" class="tipb" title="Dùng để sắp xếp thứ tự" runat="server" id="input_Position" />
                        ...
                        <div class="row-form clearfix">
                            ...
                            <div class="span10">
                                <input type="text" runat="server" id="input_Title" />
                        ...
                        <div class="row-form clearfix">
                            ...
                            <div class="span10">
                                <textarea style="min-height: 50px; width: 100%;" runat="server" id="textarea_Description"></textarea>
                        ...
                        <%--<div class="row-form clearfix">
                            ...
                            <div class="span10">
                                <a href="../css/img/no_image.jpg" id="content_a_Avatar" class="fancybox lightbox-preview" rel="group">
                                    <img runat="server" id="img_Avatar" alt="avatar" class="default-image img-polaroid avatar-preview" style="width: 180px; height: 135px;" />
                                </a>
                                <br />
                        ...
                        <%--<div class="row-form clearfix">
                            <div class="span2">
                                <a class="btn mybtn" style="cursor: no-drop;">
