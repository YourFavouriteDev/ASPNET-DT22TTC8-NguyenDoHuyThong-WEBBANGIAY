<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="PropertyList.aspx.cs" Inherits="Admin_PropertyList" %>
    ...
    <div class="content">
        ...
        <div class="breadLine">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="PropertyList.aspx">Danh mục Thuộc Tính (Cấp Cha)</a>
                    <span class="divider">&gt;</span>
                </li>
                <li>
                    <a href="PropertyList.aspx">Danh mục Thuộc Tính (Cấp Con)</a>
                </li>
            </ul>
        </div>
            ...
            <div class="row-fluid">
                <div class="span3">
                    ...
                    <div class="head clearfix">
                        ...
                        <h1>Danh mục loại Thuộc Tính (cấp con)
                        </h1>
                    </div>
                ...
                <div class="span9">
                    ...
                    <div class="block-fluid  customize">
                        ...
                        <div class="row-form clearfix">
                            ...
                            <div class="span10">
                                <input runat="server" id="input_PropertyValue" type="text" />
                                <span>VD: #000000, #111111</span>
                            </div>
                        </div>
                        <!--Mô tả-->
                        <div class="row-form clearfix">
