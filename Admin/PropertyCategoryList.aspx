<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="PropertyCategoryList.aspx.cs" Inherits="Admin_PropertyCategoryList" %>

<%@ Register Src="~/Admin/UserControl/ucMessage.ascx" TagPrefix="uc1" TagName="ucMessage" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Quản lý danh mục loại thuộc tính</title>
</asp:Content>
    ...
    <div class="content">
        ...
        <div class="breadLine">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="PropertyCategoryList.html">Danh Mục Loại thuộc tính (Cấp Cha)</a>
                </li>
            </ul>
        </div>
        ...
        <div class="workplace">
            <div class="page-header">
                <h1>Danh Mục thuộc tính (Cấp Cha)
                </h1>
            </div>
            ...
            <div class="row-fluid">
                ...
                <div class="tar">
                    <a href="PropertyList.aspx" type="button" class="btn active">
                        <i class="icon-arrow-left"></i>Trở về trang thuộc tính
                    </a>
                </div>
            </div>
