...
function(t) {
    ...
    Wolmart.appear = function(e, a, i) {
        return i && Object.keys(i).length && t.extend(intersectionObserverOptions, i),
    ...
    Wolmart.requestInterval = function(t, e, a) {
        ...
        if (!i)
            return a ? setInterval(t, e) : setTimeout(t, a);
    ...
    Wolmart.windowResized = function(t) {
        return t == Wolmart.resizeTimeStamp ? Wolmart.resizeChanged : (Wolmart.resizeChanged = Wolmart.canvasWidth != window.innerWidth,
    ...
    Wolmart.stickyContent = function() {
        ...
        e.prototype.refreshSize = function(t) {
            ...
            window.innerWidth >= 768 && this.getTop ? this.top = this.getTop() : this.options.top || (this.top = this.isWrap ? this.$el.parent().offset().top : this.$el.offset().top + this.$el[0].offsetHeight,
        ...
        e.prototype.refresh = function(e, a) {
            ...
            o.hasClass("fix-top") ? (o.css("margin-top", a.offsetTop + "px"),
            this.zIndex = this.options.max_index - a.index) : o.hasClass("fix-bottom") ? (o.css("margin-bottom", a.offsetBottom + "px"),
            this.zIndex = this.options.max_index - a.index) : o.css({
                transition: "opacity .5s",
                "z-index": this.zIndex
            }),
            this.options.scrollMode ? (this.scrollPos >= i && o.hasClass("fix-top") || this.scrollPos <= i && o.hasClass("fix-bottom") ? (o.addClass("fixed"),
            this.onFixed && this.onFixed(),
            o.hasClass("product-sticky-content") && t("body").addClass("addtocart-fixed")) : (o.removeClass("fixed").css("margin-top", "").css("margin-bottom", ""),
            this.onUnfixed && this.onUnfixed(),
            o.hasClass("product-sticky-content") && Wolmart.$body.removeClass("addtocart-fixed")),
            this.scrollPos = i) : (o.addClass("fixed"),
            this.onFixed && this.onFixed()),
            o.is(".fixed.fix-top") ? (a.offsetTop += o[0].offsetHeight,
            Wolmart.sticky_top_height = a.offsetTop) : o.is(".fixed.fix-bottom") && (a.offsetBottom += o[0].offsetHeight)) : (o.parent().css("height", ""),
    ...
    Wolmart.initFloatingParallax = function() {
        t.fn.parallax && Wolmart.$(".floating-item").each(function(e) {
            var a = t(this);
            a.data("parallax") && (a.parallax("disable"),
            a.removeData("parallax"),
            a.removeData("options")),
            a.children().addClass("layer").attr("data-depth", a.attr("data-child-depth")),
        ...
        if ("function" == typeof imagesLoaded && t.fn.isotope) {
            ...
            Wolmart.$(e).each(function() {
                ...
                e.imagesLoaded(function() {
                    ...
                    o.customDelay && Wolmart.call(function() {
                        e.isotope(o)
    ...
    Wolmart.ratingTooltip = function(t) {
        for (var e = Wolmart.byClass("ratings-full", t || document.body), a = e.length, i = function() {
            ...
            e[o].addEventListener("touchstart", i, {
                passive: !0
            })
    }
    ,
    Wolmart.setProgressBar = function(e) {
        Wolmart.$(e).each(function() {
            var e = t(this)
              ...
              , i = "";
            -1 != a.indexOf("%") ? i = a : -1 != a.indexOf("/") && (i = (i = parseInt(a.split("/")[0]) / parseInt(a.split("/")[1]) * 100).toFixed(2).toString() + "%"),
    ...
    Wolmart.accordion = function(e) {
        Wolmart.$body.on("click", e, function(e) {
            ...
            e.preventDefault(),
            0 === n.find(".collapsing").length && 0 === n.find(".expanding").length && (o.hasClass("expanded") ? n.hasClass("radio-type") || a(o) : o.hasClass("collapsed") && (n.find(".expanded").length > 0 ? Wolmart.isIE ? a(n.find(".expanded"), function() {
                a(o)
            }) : (a(n.find(".expanded")),
            a(o)) : a(o)))
        });
        var a = function(t, a) {
            ...
            t.hasClass("expanded") ? (i.removeClass("collapse").addClass("expand"),
            t.addClass("collapsing").slideUp(300, function() {
                t.removeClass("expanded collapsing").addClass("collapsed"),
                a && a()
            })) : t.hasClass("collapsed") && (i.removeClass("expand").addClass("collapse"),
    ...
    ,
    {
        ...
        open: function(o, l) {
            var c, d = this, u = t.extend(!0, {}, Wolmart.minipopupOption, o);
            c = t(Wolmart.parseTemplate(u.template, u)),
            d.space = u.space;
            ...
            p.length && p.on("load", function() {
                ...
                c.css("top", -a + c[0].offsetHeight + d.space)),
    ...
    Wolmart.scrollTo = function(e, a) {
        ...
        if ("number" == typeof e)
            ...
            var o = Wolmart.$(e);
            if (!o.length || "none" == o.css("display"))
                return;
            var n = o.offset().top
              , s = t("#wp-toolbar");
        ...
        initCategoryMenu: function() {
            ...
            if (e.length) {
                ...
                if (e.hasClass("with-sidebar")) {
                    ...
                    o.length && (e.find(".dropdown-box").css("width", o[0].offsetWidth - 20),
                    Wolmart.$window.on("resize", function() {
...
function(t) {
    var e = function(t) {
        ...
        if (e.match(/row|gutter\-\w\w|cols\-\d|cols\-\w\w-\d/g) && this.setAttribute("class", e.replace(/row|gutter\-\w\w|cols\-\d|cols\-\w\w-\d/g, "").replace(/\s+/, " ")),
        this.classList.contains("animation-slider"))
            for (var a = this.children, i = a.length, o = 0; o < i; ++o)
                a[o].setAttribute("data-index", o + 1)
    }
      , a = function(t) {
        var e, a = this.firstElementChild.firstElementChild.children, i = a.length;
        for (e = 0; e < i; ++e)
      ...
      , i = function(e) {
        ...
        i.length && (!0 === a.data("owl.carousel").options.autoplay && a.trigger("stop.owl.autoplay"),
        i.each(function() {
      ...
      , o = function(e) {
        ...
        t(e.currentTarget).find(".owl-item.active .slide-animate").each(function() {
            var e = t(this)
              ...
              , s = i.name;
            setTimeout(function() {
                if (e.css("animation-duration", o),
                e.css("animation-delay", n),
                e.addClass(s),
                e.hasClass("maskLeft")) {
                    e.css("width", "fit-content");
                    var t = e.width();
                    e.css("width", 0).css("transition", "width " + (o || "0.75s") + " linear " + (n || "0s")),
                    e.css("width", t)
                }
                o = o || "0.75s";
      ...
      , r = function(e) {
        ...
        if (1 == a.translateFlag) {
            if (a.next = i.find(".owl-item").eq(e.item.index).children().attr("data-index"),
            i.find(".show-content").removeClass("show-content"),
            a.prev != a.next) {
                if (i.find(".show-content").removeClass("show-content"),
                ...
                i.find(".owl-item").eq(e.item.index).find(".slide-animate").addClass("show-content");
            a.translateFlag = 0
        }
    };
    Slider.defaults = {
    ...
    Slider.zoomImageRefresh = function() {
        this.$element.find("img").each(function() {
            ...
            if (t.fn.zoom) {
                var a = e.data("zoom");
                void 0 !== a ? a.refresh() : (Wolmart.zoomImageOptions.zoomContainer = e.parent(),
                e.zoom(Wolmart.zoomImageOptions))
            }
        })
    }
...
function(t) {
    ...
    Sidebar.prototype.init = function(a) {
        ...
        i.$sidebar = t("." + a),
        i.isNavigation = !1,
        i.$sidebar.length && (i.isNavigation = i.$sidebar.hasClass("sidebar-fixed") && i.$sidebar.parent().hasClass("toolbox-wrap"),
        i.isNavigation && (e = e.bind(this),
    ...
    var e = {
        init: function() {
            ...
            Wolmart.$body.on("mousedown", ".select-menu", function(e) {
                ...
                a.is(i.parent()) ? (!o && a.addClass("opened"),
                e.stopPropagation()) : (i.parent().toggleClass("active"),
                i.parent().hasClass("active") ? (t(".selected-items").children().length < 2 && t(".selected-items").show(),
                t('<a href="#" class="selected-item">' + i.text().split("(")[0] + '<i class="la la-close"></i></a>').insertBefore(".selected-items .filter-clean").hide().fadeIn().data("link", i.parent())) : t(".selected-items > .selected-item").filter(function(t, e) {
            ...
            Wolmart.$body.on("click", ".filter-items a", function(e) {
                ...
                a.hasClass("search-ul") || a.parent().hasClass("select-menu") || (t(this).parent().toggleClass("active"),
                e.preventDefault())
            }),
            ...
            Wolmart.$body.on("click", ".product:not(.product-single) .btn-wishlist", function(e) {
                ...
                setTimeout(function() {
                    a.removeClass("load-more-overlay loading"),
                    a.toggleClass("w-icon-heart").toggleClass("w-icon-heart-full")
                }, 500)
            }),
            ...
            function() {
                var e, a = [], i = t(".page-wrapper > .compare-popup");
                function o() {
                    i.find(".title").after('<p class="compare-count text-center text-light mb-0">(' + e + " Products)</p>"),
                    i.find(".compare-count").length > 1 && i.find("p:last-child").remove()
                }
                i.length || document.body.classList.contains("docs") || (t(".page-wrapper").append('<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">Compare Products</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">Clean All</a>                        <a href="compare.html" class="btn btn-dark btn-rounded">Start Compare !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'),
                i = t(".page-wrapper > .compare-popup")),
                Wolmart.$body.on("click", ".product .btn-compare", function(n) {
                    var s = t(this);
                    ...
                    t(".page-wrapper .product img").each(function() {
                        ...
                        a.forEach(function(t) {
                            if (i == t) {
                                ...
                                a.length && (a.removeClass("added").attr("href", "#"),
                                a.toggleClass("w-icon-check-solid").toggleClass("w-icon-compare"))
                            }
                        })
                    }),
                    a.splice(0, 4),
        ...
        initVariation: function(e) {
            t(".product:not(.product-single) .product-variations > a").on("click", function(e) {
                ...
                a.hasClass("active") ? i.attr("src", a.data("src")) : (i.attr("src", i.data("image-src")),
                a.blur()),
                e.preventDefault()
            })
        },
        initProductsScrollLoad: function(e) {
            var a, i = Wolmart.$(e), o = t(e).data("url");
            ...
            var n = function(e) {
                window.pageYOffset > a + i.outerHeight() - window.innerHeight - 150 && "loading" != i.data("load-state") && t.ajax({
                    ...
                    success: function(e) {
                        ...
                        i.data("load-count", ++o),
                        o > 2 && window.removeEventListener("scroll", n, {
                            passive: !0
                        })
                    },
                    failure: function() {
...
function(t) {
    ...
    QuantityInput.prototype.init = function(t) {
        ...
        e.$minus = t.parent().find(".quantity-minus").on("mousedown", function(t) {
            t.preventDefault(),
            e.startDecrease()
        }).on("touchstart", function(t) {
        ...
        e.$plus = t.parent().find(".quantity-plus").on("mousedown", function(t) {
            t.preventDefault(),
            e.startIncrease()
        }).on("touchstart", function(t) {
            t.cancelable && t.preventDefault(),
...
function(t) {
    ...
    Popup.prototype.init = function(e, a) {
        ...
        i.isOpen && i.content && !i.content.hasClass("login-popup") ? (i.close(),
        setTimeout(function() {
...
function(t) {
    var e = {
      ...
      , a = function(t) {
        ...
        a >= e + t.$productThumb[0].offsetHeight ? (t.$thumbs.css("top", parseInt(t.$thumbs.css("top")) - t.$productThumb[0].offsetHeight),
        t.$thumbUp.removeClass("disabled")) : a > e ? (t.$thumbs.css("top", parseInt(t.$thumbs.css("top")) - Math.ceil(a - e)),
        t.$thumbUp.removeClass("disabled"),
        t.$thumbDown.addClass("disabled")) : t.$thumbDown.addClass("disabled")
    }
      , i = function(t) {
        var e = t.$thumbsWrap.offset().top
          , a = t.$thumbs.offset().top;
        a <= e - t.$productThumb[0].offsetHeight ? (t.$thumbs.css("top", parseInt(t.$thumbs.css("top")) + t.$productThumb[0].offsetHeight),
        t.$thumbDown.removeClass("disabled")) : a < e ? (t.$thumbs.css("top", parseInt(t.$thumbs.css("top")) - Math.ceil(a - e)),
        t.$thumbDown.removeClass("disabled"),
        t.$thumbUp.addClass("disabled")) : t.$thumbUp.addClass("disabled")
    }
      , o = function(a) {
        a.thumbsIsVertical ? (a.$thumbs.hasClass("owl-carousel") && (a.$thumbs.data("owl.carousel").destroy(),
        ...
        a.$thumbDown.toggleClass("disabled", a.thumbsHeight <= a.$thumbsWrap[0].offsetHeight)) : (a.$thumbs.removeAttr("style"),
        a.$thumbs.hasClass("owl-carousel") || a.$thumbs.addClass("owl-carousel").attr("class", a.$thumbs.attr("class") && a.$thumbs.attr("class").replace(/row|gutter\-\w\w|cols\-\d|cols\-\w\w-\d/g, "").replace(/\s+/, " ")).owlCarousel(t.extend(!0, a.isQuickView ? {
            onInitialized: n,
            onResized: n
        } : {}, e)))
    }
      ...
      , s = function(e) {
        var a = t(this);
        a.hasClass("added") || (e.preventDefault(),
    ...
    ProductSingle.prototype.init = function(e) {
        ...
        r._isPgVertical = !1,
        r.isQuickView && (n = n.bind(this),
        Wolmart.ratingTooltip()),
        l.on("initialized.owl.carousel", function(e) {
            document.body.classList.contains("home") || (r.isQuickView || l.append('<a href="#" class="product-gallery-btn product-image-full"><i class="w-icon-zoom"></i></a>'),
            l.parent().hasClass("product-gallery-video") && (r.isQuickView || l.append('<a href="#" class="product-gallery-btn product-degree-viewer" title="Product 360 Degree Gallery"><i class="w-icon-rotate-3d"></i></a>'),
        ...
        "complete" === Wolmart.status && (Wolmart.slider(l),
        Wolmart.initQtyInput(e.find(".quantity"))),
        r.$wrapper.find(".product-thumbs-sticky").length && (r.isStickyScrolling = !1,
        r.$wrapper.on("click", ".product-thumb:not(.active)", r.clickStickyThumbnail.bind(this)),
        window.addEventListener("scroll", r.scrollStickyThumbnail.bind(this), {
            passive: !0
        })),
        function(e) {
    ...
    ProductSingle.prototype.setThumbsActive = function(t) {
        var e = this
          , a = e.$thumbsDots.eq(t);
        if (e.$thumbsDots.filter(".active").removeClass("active"),
        a.addClass("active"),
        e.thumbsIsVertical) {
    ...
    ProductSingle.prototype.clickStickyThumbnail = function(e) {
        var a = this
          , i = t(e.currentTarget)
          , o = (i.parent().children(".active").index(),
        i.index() + 1);
        ...
        n.length && (n = n.offset().top + 10,
        Wolmart.scrollTo(n, 500)),
        setTimeout(function() {
...
function(t) {
    function e(e) {
        e.preventDefault();
        var a, i, o = t(e.currentTarget), n = o.closest(".product-single");
    ...
    function o(e) {
        ...
        if (a.hasClass("disabled"))
            ...
            if (i.length)
                ...
                var o = '<div class="alert alert-success alert-cart-product mb-2">                            <a href="cart.html" class="btn btn-success btn-rounded">View Cart</a>                            <p class="mb-0 ls-normal">“' + a.closest(".product-single").find(".product-title").text() + '” has been added to your cart.</p>                            <a href="#" class="btn btn-link btn-close"><i class="close-icon"></i></a>                            </div>';
    ...
    Wolmart.initProductSinglePage = function() {
        ...
        function(e) {
            ...
            function n() {
                ...
                a.hasClass("fix-bottom") && window.innerWidth > 767 || (a.hasClass("fix-bottom") && window.innerWidth < 768 && a.removeClass("fix-bottom").addClass("fix-top"),
        ...
        document.body.classList.contains("home") || Wolmart.$body.on("click", ".product-image-full", e).on("click", ".review-image img", e).on("click", ".product-video-viewer", a).on("click", ".product-degree-viewer", function(e) {
            e.preventDefault(e),
...
function(t) {
    ...
    Calendar.prototype.init = function(a, i) {
        this.element = a,
        this.settings = t.extend({}, !0, Calendar.defaultOptions, Wolmart.parseOptions(a.attr("data-calendar-options")), i),
        this.today = new Date,
        e = e.bind(this);
    ...
    Calendar.prototype.render = function(e, a) {
        ...
        for (var m = l; m < c; m.setDate(m.getDate())) {
            ...
            for (u = 0; u < 7; u++) {
                ...
                m.toDateString() == (new Date).toDateString() && f.find(".day").addClass("today"),
                m.getMonth() != e.getMonth() && f.find(".day").addClass("disabled"),
                h.append(f),
    ...
    Wolmart.slideContent = function(e) {
        ...
        a.on("click", function(t) {
            t.preventDefault(),
            i.hasClass("open") ? (i.removeClass("open").slideUp(),
            a.find(".custom-checkbox").removeClass("checked")) : (i.addClass("open").slideDown(),
