                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="login_submit d-flex justify-content-between">
                                        ...
                                        <asp:LinkButton
                                            ...
                                            ID="LinkButton_Login"
                                            OnClick="LinkButton_Login_Click"></asp:LinkButton>
                                    </div>
                                ...
                                <ContentTemplate>
                                    <asp:Panel runat="server" DefaultButton="LinkButton_Register" class="box-authentication col-xs-6">
                                        ...
                                        <div class="login_submit">
                                            <asp:LinkButton Text="Đăng ký" runat="server" class="button" ID="LinkButton_Register" OnClick="LinkButton_Register_Click"></asp:LinkButton>
                                        </div>
                                    </asp:Panel>
                                </ContentTemplate>
                            </asp:UpdatePanel>
